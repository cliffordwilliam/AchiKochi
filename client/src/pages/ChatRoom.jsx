	...
	return (
		<div>
			{code ? (
				...
				<a className="btn m" href={"https://accounts.spotify.com/authorize?client_id=c427c4dced8b46f092bea016eb4ab5a0&response_type=code&redirect_uri=http://localhost:5173/homepage&scope=streaming%20user-read-email%20user-read-private%20user-library-read%20user-library-modify%20user-read-playback-state%20user-modify-playback-state"}>
					Login With Spotify
				</a>
			)}
			{/* <h1>{chatRoomTitle}</h1> */}
					...
					<ul>
						{chats.map((chat) => (
							<li key={chat.id}>
								...
								<div>Sent at: {new Date(chat.createdAt).toLocaleString()}</div>
							</li>
						))}
					</ul>
				</>
