  ...
  return (
    <>
      ...
      <section className="sec">
        ...
        <p>
          Best Weeb's Forum Website with Realtime Chatting and Best Arts Post.{" "}
          <br />
          <br />
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi
          consectetur minus fugiat consequuntur quia explicabo distinctio
          reprehenderit suscipit adipisci? Natus quas repudiandae recusandae
          laboriosam fugit molestiae error velit earum corrupti. Lorem ipsum
          dolor sit, amet consectetur adipisicing elit. Impedit est ex quos
          totam eius recusandae molestias eligendi iusto quis commodi quaerat
          ipsum similique, nobis maiores tempore mollitia perspiciatis eos.
          Dolorum! Lorem ipsum dolor sit, amet consectetur adipisicing elit.
          Provident quas veritatis voluptatem aspernatur dignissimos officia
          rem, sit quaerat, enim, mollitia eveniet animi ad repellat consequatur
          similique perferendis id numquam voluptate.
        </p>
      </section>
